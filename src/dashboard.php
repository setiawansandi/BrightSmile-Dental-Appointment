...
/*
   If doctor  -> list their appointments with patients (counterpart = patient)
   If patient -> list their appointments with doctors (counterpart = doctor)
*/
$appointments = [];
...
if ($isDoctor) {
  ...
  $sqlAppts = "
        SELECT
            ...
            a.status,
            CONCAT_WS(' ', pu.first_name, pu.last_name) AS counterpart_name  -- patient
        FROM appointments a
  ...
  $sqlAppts = "
        SELECT
            ...
            DATE_FORMAT(a.appt_time, '%H:%i')    AS time_fmt,
            a.status,
            CONCAT_WS(' ', du.first_name, du.last_name) AS counterpart_name  -- doctor
        FROM appointments a
...
<head>
  ...
  <!-- Root first, page overrides second -->
    ...
    <div class="section-card history-card">
      ...
      <div class="table-wrap">
        <table class="appt-table">
          <colgroup>
            <col style="width:160px"> <!-- Patient/Doctor -->
            <col style="width:120px"> <!-- Date -->
            <col style="width:90px"> <!-- Time -->
            <col style="width:120px"> <!-- Status -->
            <col style="auto"> <!-- Actions -->
          </colgroup>
          <thead>
            <tr>
